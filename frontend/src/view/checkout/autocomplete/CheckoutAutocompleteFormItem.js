...
import CheckoutFormModal from 'view/checkout/form/CheckoutFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/checkout/checkoutSelectors';

class CheckoutAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return CheckoutService.listAutocomplete(value, limit);
  };
