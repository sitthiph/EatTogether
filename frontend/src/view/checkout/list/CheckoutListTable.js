...
class CheckoutListTable extends Component {
  state = {
                  ...
                  <tr key={row.id}>
                    <th className="th-checkbox" scope="row">
                      <div className="custom-control custom-checkbox">
                        ...
                        <td>
                          {fields.userName.forView(
                            row[fields.userName.name],
                          )}
                        </td>
                        <td>
                          {fields.orderList.forView(
                            row[fields.orderList.name],
                          )}
                        </td>
                        <td>
                          {fields.apiKeyRestaurant.forView(
                            row[fields.apiKeyRestaurant.name],
                          )}
                        </td>
                        <td>
                          {fields.apiKeysFood.forView(
                            row[fields.apiKeysFood.name],
                          )}
                        </td>
                        <td>
                          {fields.foodName.forView(
                            row[fields.foodName.name],
                          )}
                        </td>
...
export default connect(select)(CheckoutListTable);
