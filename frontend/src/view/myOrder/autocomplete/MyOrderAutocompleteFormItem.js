...
import MyOrderFormModal from 'view/myOrder/form/MyOrderFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/myOrder/myOrderSelectors';

class MyOrderAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return MyOrderService.listAutocomplete(value, limit);
  };
