...
import exporterFields from 'modules/myOrder/list/myOrderListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'MYORDER_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await MyOrderService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.myOrder.exporterFileName'),
