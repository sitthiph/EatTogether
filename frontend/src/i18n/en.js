const en = {
  ...
  entities: {
    myOrder: {
      ...
      label: 'My Orders',
      menu: 'My Orders',
      exporterFileName: 'myOrder_export',
      list: {
        menu: 'My Orders',
        title: 'My Orders',
      },
      create: {
        success: 'My Order saved successfully',
      },
      update: {
        success: 'My Order saved successfully',
      },
      destroy: {
        success: 'My Order deleted successfully',
      },
      destroyAll: {
        success: 'My Order(s) deleted successfully',
      },
      edit: {
        title: 'Edit My Order',
      },
      ...
      importer: {
        title: 'Import My Orders',
        fileName: 'myOrder_import_template',
        hint:
  ...
  roles: {
    ...
    myOrderEditor: {
      label: 'My Order Editor',
      description: 'Edit access to My Orders',
    },
    myOrderViewer: {
      label: 'My Order Viewer',
      description: 'View access to My Orders',
    },
    checkoutEditor: {
      label: 'Checkout Editor',
      description: 'Edit access to Checkouts',
    },
    checkoutViewer: {
      label: 'Checkout Viewer',
      description: 'View access to Checkouts',
    },
  },
